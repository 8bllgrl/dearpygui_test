...
class AudioTab:
    ...
    def update_volume(self, setting_id, app_data):
        self.audio_manager.update_volume(setting_id, app_data)
    ...
    def reset_audio_settings(self, sender):
        ...
        for control in self.volume_controls:
            dpg.set_value(control.volume_id, self.audio_manager.master_volume if control.setting_id == AudioSetting.MASTER_VOLUME else self.audio_manager.music_volume)
